...
public class PercolationStats {
	...
	/**
	 * Constructor used to perform t independent tests on a 
	 * n-by-b grid
	...
	/** 
	 * Method used to return the row index when
	 * given a one-dimensional position like an array index
	...
	/** 
	 * Method used to return the column index when
	 * given a one-dimensional position like an array index
	 * @param p the array index
